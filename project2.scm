...
(define wave-252
  (segments->painter (list (make-segment (make-vect 0.25 0) (make-vect 0.35 0.4))
                           ...
                           (make-segment (make-vect 0.65 0.65) (make-vect 0.7 0.8))
                           (make-segment (make-vect 0.7 0.8) (make-vect 0.65 1))
                           (make-segment (make-vect 0.65 0.8) (make-vect 0.5 0.75))
                           (make-segment (make-vect 0.5 0.75) (make-vect 0.33 0.8)))))
(define (corner-split-252 painter n)
  (if (= n 0)
      painter
      (let ((up (up-split painter (- n 1)))
            (right (right-split painter (- n 1)))
          ...
          (beside (below painter up)
                  (below right corner)))))
(define (square-limit-252 painter n)
